...
import { Container, Header, View, DeckSwiper, Card, Button, CardItem, Thumbnail, Text, Left, Body } from 'native-base';
const cards = [
  {
    text: 'Sofitel Hotel Ivoire',
    name: 'Booking now',
    image: require('../img/ivoire_hotel/1.jpg'),
  },
  {
    text: 'Sofitel Hotel Ivoire',
    name: 'Booking now',
    image: require('../img/ivoire_hotel/2.jpg'),
  },
  {
    text: 'Sofitel Hotel Ivoire',
    name: 'Booking now',
    image: require('../img/ivoire_hotel/3.jpg'),
  },
  {
    text: 'Sofitel Hotel Ivoire',
    name: 'Booking now',
    image: require('../img/ivoire_hotel/4.jpg'),
  },
];
